                ...
                <tr>
                    <td>
                        <table cellspacing="0" cellpadding="0" width="100%" style="background: #ffffff; -webkit-border-radius: 10px; -moz-border-radius: 10px; border-radius: 10px;">
                            <tr>
                                <td style="background: url(https://api.ilmyst.com/images/vector-1.png) no-repeat bottom right; background-size: 65% auto; border-bottom: solid 1px #e5e4ed; font-family: Arial Rounded MT Bold, Helvetica Rounded, Arial, sans-serif; padding:30px 20px 70px 20px;">
                                    <table cellpadding="0" cellspacing="0" width="100%" style="max-width: 340px;">
                                        <tr>
                                            <td>
                                                <h3 style="color:#5c17cf; font-size:26px; font-weight: normal; margin:0 0 14px; padding:0;">Your enrollment has been completed!</h3>
                                                ...
                                                <p style="color:#5c5666; font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight: normal; margin:0; padding:0; line-height: 1.6em;">
                                                    Thank you for choosing ilmyst.com, Your enrollment has been successful for the following request.
                                                </p>
                            ...
                            <tr>
                                <td style="padding: 30px 20px; border-bottom: solid 1px #e5e4ed;">
                                    <h3 style="font-family: Arial Rounded MT Bold, Helvetica Rounded, Arial, sans-serif; color:#5c17cf; font-size:20px; font-weight: normal; margin:0 0 12px; padding:0;">Enrollment for:</h3>
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        @foreach($order->batches as $batch)
                                            <p style="color:#5c5666; font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight: normal; margin:0 0 8px; padding:0 0 8px; line-height: 1.6em;">{{$batch->title}}</p>
                                        ...
                                        @foreach($order->courses as $course)
                                            <p style="color:#5c5666; font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight: normal; margin:0 0 8px; padding:0 0 8px; line-height: 1.6em;">{{$course->title}}</p>
                                            {{--<p style="color:#5c5666; font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight: normal; margin:0 0 8px; padding:0 0 8px; line-height: 1.6em;"><?php echo $payment_option->description ?></p>--}}
                                        @endforeach
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding: 20px 20px; border-top: solid 1px #e5e4ed;">
                                    ...
                                    <p style="color:#5c5666; font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight: normal; margin:0; padding:7px 0; line-height: 1.6em;">You've made the payment against reference no: <strong>{{$order->order_reference}}</strong>. Please keep an eye on your email or announcement section at ilmyst.com, you will be notified soon about the date of first class.</p>
                                    <p style="color:#5c5666; font-family: Helvetica, Arial, sans-serif; font-size:14px; font-weight: normal; margin:0; padding:7px 0; line-height: 1.6em;">Please feel free to call us at <strong>+92 3452975338</strong> or send us an email at <strong>enquiry@ilmyst.com</strong> if you have any query</p>
                                </td>
                            </tr>
                        </table>
