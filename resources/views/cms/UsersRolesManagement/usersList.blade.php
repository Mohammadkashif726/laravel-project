                                ...
                                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                            <a href="/cms/users/add-new" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
                                ...
                                <table class="m-datatable" id="html_table" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th title="Field #6">Assigned roles</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>C: 9 Aug, 2018 <br/> M: 21 Sep, 2018</td>
                                        <td>Marketing Manager, Blog manager</td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="#" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                                <a href="#" class="btn btn-secondary"><i class="fa fa-trash-o"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
