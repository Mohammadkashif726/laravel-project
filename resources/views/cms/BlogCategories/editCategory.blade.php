                ...
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{route('categories.index')}}" class="m-nav__link"><span class="m-nav__link-text">View all categories</span></a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link"><span class="m-nav__link-text">Edit <strong>{{$blogCategories->title}}</strong></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <form action="{{route('categories.update', $blogCategories->id)}}" method="post" class="m-form m-form--fit m-form--label-align-right">
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" placeholder="Enter Description">{{$blogCategories->description}}</textarea>
                                </div>
                                <div class="form-group m-form__group">
                            ...
                            <div class="m-portlet__foot m-portlet__foot--fit">
                                <div class="m-form__actions">
                                    <a href="/admin/categories/create" class="btn btn-lg btn-secondary">
                                        Create new
                                    </a>
