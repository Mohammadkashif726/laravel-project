                ...
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="{{route('posts.index')}}" class="m-nav__link"><span class="m-nav__link-text">Posts</span></a>
                        </li>
                        <li class="m-nav__separator">-</li>
                        <li class="m-nav__item">
                            <a href="" class="m-nav__link"><span class="m-nav__link-text">Add new Post</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    ...
                                    <h3 class="m-portlet__head-text">Enter post detail</h3>
                                </div>
                            </div>
                        </div>
                        <!--begin::Form-->
                        <form action="{{route('posts.store')}}" method="post" class="m-form m-form--fit m-form--label-align-right">
                            @csrf
                            @if($errors->all())
